...
def run_realization(realization_idx, num_cells_target, d_target_str, steps, R_str, area_per_cell_str):
    ...
    # Extract final radial distances for spatial analysis
...
if __name__ == '__main__':
    ...
    if final_plot_data is not None:
        ...
        plt.axis('equal')
        plt.title(f"Sample Geometry (Realization 0, {Nc} Unweighted Finite Cells)")
    ...
    plt.title(f"Unweighted Finite Convergence Limit ({num_realizations} Realizations, {num_cells_target} Cells)")
